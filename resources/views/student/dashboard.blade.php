    ...
    <div class="card welcome-widget">
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="welcome-content">
                        <h3 class="mb-3 fw-semibold">Welcome back, {{ auth()->user()->student->first_name ?? 'Student' }}! 👋</h3>
                        ...
                        <div class="d-flex gap-3">
                            ...
                            <a href="{{ route('student.subjects.index') }}" class="btn btn-soft-primary">My Subjects</a>
                        </div>
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col-xl-8">
                <div class="card">
                <div class="flex-shrink-0">
    <a href="{{ route('student.timetable') }}" class="btn btn-soft-primary btn-sm">
...
@if($timetable && $todaySlots->count() > 0)
    @foreach($todaySlots as $slot)
        <tr>
            ...
            <td>{{ $slot->teacher->first_name ?? '' }} {{ $slot->teacher->last_name ?? '' }}</td>
            ...
            <div class="col-xl-8">
                <div class="card">
                    <div class="card-header align-items-center d-flex">
                        ...
                        <div class="flex-shrink-0">
                            <a href="{{ route('student.subjects.index') }}" class="btn btn-soft-primary btn-sm">
                                            ...
                                            <div class="card-body p-3">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        ...
                                                        <p class="text-muted mb-0 small">{{ $subject->code }}</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
            ...
            <div class="col-xl-4">
                <div class="card">
                    <div class="card-header align-items-center d-flex">
                        ...
                        <div class="flex-shrink-0">
                            <a href="{{ route('student.invoices.index') }}" class="btn btn-soft-primary btn-sm">
                    ...
                    <div class="card-body">
                        ...
                        @if($pendingInvoices->count() > 0)
                            ...
                            @foreach($pendingInvoices as $invoice)
                                <div class="invoice-mini p-3 mb-3 {{ $invoice->status === 'overdue' ? 'invoice-overdue' : 'invoice-pending' }}">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div>
                                            <h6 class="mb-1">Invoice #{{ $invoice->invoice_number }}</h6>
                                            <p class="text-muted mb-0 small">Due: {{ $invoice->due_date->format('d M, Y') }}</p>
                                        </div>
                                        <div class="text-end">
                                            <h6 class="mb-1">TSh {{ number_format($invoice->total_amount, 2) }}</h6>
                                    ...
                                    <div class="mt-2 text-end">
                                        <a href="{{ route('student.invoices.show', $invoice) }}" class="btn btn-sm btn-soft-primary">
                                            View Details
                                        </a>
                                    </div>
                                </div>
