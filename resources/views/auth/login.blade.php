                        ...
                        <div class="card overflow-hidden border-0 shadow-lg" 
                            ...
                            <div class="row g-0">
                                <div class="col-lg-6 d-none d-lg-block position-relative" 
                                     style="background: url('{{ URL::asset('school/student1.png') }}') center/cover no-repeat;">
                                    ...
                                    <div class="p-lg-5 p-4 h-100 d-flex flex-column position-relative">
                                        <div class="mb-4 text-center">
                                            <a href="index" class="d-block">
                                                <img src="{{ URL::asset('school/logo.png') }}" alt="" height="88" class="mx-auto">
                                            </a>
                                        </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="p-lg-5 p-4">
                                        <div class="text-center mt-2 mb-4 d-block d-lg-none">
                                            <img src="{{ URL::asset('school/logo.png') }}" alt="" height="72">
                                        </div>
                                        <div class="mb-4">
